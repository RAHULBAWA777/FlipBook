...
// GAME 1
    gameWindow=()=>{
        window.open('vanilla-js-snake/dist/snakeGame.html','_self')
     }

    document.getElementById('c10').onclick=()=>{gameWindow()}
// GAME 2
    gameWindow2=()=>{
        window.open('balloon game/balloonGame.html','_self')
     }

    document.getElementById('c17').onclick=()=>{gameWindow2()}
    // GAME 3
    gameWindow3=()=>{
        window.open('pure-css-tic-tac-toe/dist/ticTacToeGame.html','_self')
     }

    document.getElementById('c25').onclick=()=>{gameWindow3()}